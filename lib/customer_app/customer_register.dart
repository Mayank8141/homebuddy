...
class _customer_register_screenState extends State<customer_register_screen> {
  ...
  // ================= ADMIN NOTIFICATION =================
  Future<void> sendAdminNotificationOnCustomerRegister({
    ...
    for (var admin in adminSnapshot.docs) {
      ...
      await docRef.set({
        ...
        "message": "$customerName has registered as a customer",
  ...
  void _openCitySearch() {
    if (_allCities.isEmpty) {
      showMsg("Cities are loading, please wait", Colors.orange);
      return;
    }
  ...
  Future<void> registerCustomer() async {
    ...
    try {
      ...
      await sendAdminNotificationOnCustomerRegister(
        customerId: uid,
